...
// Mostrar tVector en formato agradable para las cotas de las raices positivas y negativas
function mostrarVectorCotas(aux: tVector): string;
var
  cad: string;
  i: integer;
begin
...
// Mostrar tVector en formato agradable para las posibles raices
function mostrarVectorRaices(aux: tVector): string;
var
  cad: string;
  i: integer;
begin
...
begin
  ...
  if(b) then begin
    ...
    if(cboxRaicesEnteras.Checked) then begin
      ...
      edtResultadoRaicesEnteras.Text := mostrarVectorRaices(vectorCotas);
    end else begin
    ...
    if(cboxRaicesRacionales.Checked) then begin
      ...
      edtResultadoRaicesRacionales.Text := mostrarVectorRaices(vectorCotas);
    end else begin
